...
Multiple customers (Katy Markham, Order #1329; Pat McCarty, Order #2679)
describe the plushie toys as advertised "indestructible" or "durable and
indestructible" on Facebook, and are disappointed when normal chewing
destroys them quickly. The Shopify product listing itself is titled
"Plushies – Designed for Furry Friends Who Destroy Everything" — i.e. the
store's own listing does not claim indestructibility, but external ad copy
apparently does. One customer (Katy Markham) has explicitly invoked the UK
Consumer Rights Act 2015 and referenced a pattern of similar complaints on
Trust Pilot. This is a marketing/legal question worth the owner's direct
attention — a support bot's refund policy can't paper over a false-advertising
claim, and no rule in the policy doc auto-resolves it. See
`docs/2026-07-18-backlog-triage.md` for the specific thread.
