# Entwürfe zum Kopieren — Stand 2026-08-30

**Warum diese Datei existiert:** Der Gmail-Schreibpfad (`create_draft`,
`label_message`) bricht seit dem 21.08. bei jedem Versuch ab — rund zehn
Versuche über neun Tage, kein einziger durchgegangen. Lesen und Shopify-Abfragen
funktionieren. Solange das so ist, kann der Bot keine Entwürfe im Postfach
anlegen.

Damit die dringendsten Fälle nicht weiter liegen bleiben, stehen die Texte hier
im Klartext. **Zum Absenden in Gmail kopieren.**

Diese Texte sind **neu geschrieben**, nicht aus dem Gedächtnis rekonstruiert —
sie haben nie als Gmail-Entwurf existiert. Die Texte aus den Logs vom 13.08.
liegen dagegen wirklich als Entwürfe im Postfach; die sind dort abzurufen, nicht
hier.

**Vor jedem Absenden `get_thread` bzw. den Thread in Gmail prüfen** — seit dem
15.08. gehen aus dem Postfach auch Antworten raus, die nicht aus einem Bot-Lauf
stammen. Mehrere Fälle unten haben inzwischen eine Zwischenantwort bekommen.

---

## 1. #6283 — ru4crzn@att.net — Hund hat möglicherweise ein Teil gefressen

**Zeitkritisch. Zuerst senden.** Betreff: Antwort im bestehenden Thread.

> Hi,
>
> Thank you for telling me, and I want to answer the part about the missing
> piece first, because that matters more than anything else in your email.
>
> Please don't spend time looking for the blue ear. If there's any chance your
> dog swallowed it, the thing worth doing is watching him for vomiting,
> retching, loss of appetite, straining, or a hunched or uncomfortable posture,
> and calling your vet if any of that shows up — or sooner if you'd rather have
> it checked than wait. A vet would rather hear from you early over something
> that turns out to be nothing.
>
> On the toy itself and how it was described to you: I've passed your emails to
> the owner of the business rather than answering that with a policy line. You
> raised it plainly and it deserves a proper answer, not a form reply.
>
> If your vet does get involved, tell me and I'll make sure it goes straight to
> the owner.
>
> Lisa
> Paw-Friends UK

⚠️ **Zusage darin:** Weitergabe an den Owner und eine Rückmeldung, falls der
Tierarzt involviert wird. Keine Erstattungszusage.

**Eskalationsgrund (nur fürs Log):** Möglicher Sicherheits-/Tiergesundheitsvorfall
plus ausdrücklich bestrittene Werbeaussage.

---

## 2. andysire@yahoo.co.uk — zweiter Verschluckungsfall, plus falsches Thema beantwortet

**Zeitkritisch.** Er hat am 29.08. eine Antwort über Evri-Sendungsverfolgung
bekommen, auf eine Mail über ein zerstörtes Produkt und verschluckte Teile.

> Hi Andy,
>
> You're right, and I'm sorry — the reply you got was about parcel tracking and
> had nothing to do with what you actually wrote to us about. That shouldn't
> have happened, and it means the important part of your email has gone
> unanswered for three days.
>
> The part I should have answered first: you said your dog swallowed some of the
> pieces. Please keep an eye on him for vomiting, retching, going off his food,
> straining, or seeming uncomfortable or hunched, and ring your vet if you see
> any of that — or sooner if you'd rather not wait and see. If a vet does get
> involved, tell me.
>
> On the toys themselves and the way they were advertised to you, I've passed
> your emails to the owner of the business. That's not me putting you off; it's
> that the point you've raised needs an answer from the business rather than a
> standard reply from me.
>
> Lisa
> Paw-Friends UK

⚠️ **Zusage darin:** Weitergabe an den Owner. Keine Erstattungszusage.

**Eskalationsgrund (nur fürs Log):** Möglicher Sicherheitsvorfall, bestrittene
Werbeaussage, fehlerhaft beantwortet.

---

## 3. #3988 — dominichigney@gmail.com — formelle Beschwerde lag im Papierkorb

Seine Mail vom 09.08. trägt `UNREAD, IMPORTANT, TRASH`. Sie wurde ungelesen in
den Papierkorb verschoben und nie beantwortet. Am 29.08. hat er nachgefasst.

> Hi Dominic,
>
> You wrote on 9 August and got nothing back. I've looked into why, and the
> honest answer is that your email was moved out of our inbox without being
> read. That's our failure, not a case of it slipping down a queue, and I'm not
> going to dress it up as anything else.
>
> You raised a formal complaint about the way the toys were advertised and
> quoted the wording back to us. That isn't something I'm going to answer with
> a standard policy reply — it's gone to the owner of the business, along with
> the fact that three weeks passed before anyone responded to you.
>
> I'm sorry you had to write twice to get an acknowledgement.
>
> Lisa
> Paw-Friends UK

⚠️ **Zusage darin:** keine — nur die Weitergabe und das Eingeständnis.

**Eskalationsgrund (nur fürs Log):** Formelle Beschwerde, bestrittene
Werbeaussage, gelöschte Erstmail, zweiter Kontakt.

**Zusätzlich prüfen:** `in:trash` durchsuchen. Bei priceann100@gmail.com trägt
die älteste Mail des Threads ebenfalls `TRASH` — es liegen möglicherweise
weitere unbeantwortete Kundenmails im Papierkorb.

---

## 4. priceann100@gmail.com — Erstattung seit dem 17.07. zugesagt, nie gezahlt

Vierter Kontakt. Am 09.08. ist ihr aus dem Postfach ehrlich geschrieben worden,
man wolle die Zusage nicht wiederholen, ohne sie einlösen zu können.

> Hi Ann,
>
> Six weeks ago you were told you'd get your money back, and you still haven't.
> Everything since then — including my colleague's reply on 9 August — has been
> us explaining why we couldn't confirm it rather than actually paying you.
>
> I'm not going to make you that promise a fourth time from this desk. What I've
> done instead is put it in front of the owner of the business as an outstanding
> payment, with your order number and the amount, because that's who has to
> release it.
>
> You've been more patient with this than we've earned.
>
> Lisa
> Paw-Friends UK

⚠️ **Zusage darin:** keine neue Erstattungszusage — bewusst. Die Zusage vom
17.07. steht bereits; eine fünfte Wiederholung ohne Zahlung macht es schlimmer.
**Betrag und Bestellnummer vor dem Senden aus Shopify holen.**
...
## 7. #3310 — tcarroll@cadvanced.com — Chargeback bereits eingereicht

Am 19.08. und 20.08. sind zwei Vorlagen-Absagen rausgegangen; 51 Minuten nach
der zweiten hat er den Streitfall bei seinem Kreditkartenanbieter eröffnet.
**Diesen Text nur senden, wenn der Owner die Chargeback-Antwort noch nicht
selbst übernommen hat.**

> Hi Tim,
>
> Thank you for coming back to me, and I'm sorry this has got to the point it
> has.
>
> There are two things in your emails I'm not going to try to settle from this
> desk: what our advertising claimed, and the dispute you've now opened with
> your card provider. Both of those need to go to the owner of the business, and
> I'm passing your order and the full email history over.
>
> I'm not going to give you a decision today that I'm not in a position to make.
> What I can tell you is that it's with someone who can make it.
>
> Lisa
> Paw-Friends UK

⚠️ **Zusage darin:** keine — nur die Weitergabe. Bewusst **ohne** Wiederholung
der Rückgabepolicy: die ist ihm schon zweimal geschickt worden und hat den
Chargeback ausgelöst.
...
15.09. und steht auf `UNFULFILLED` — eine Korrektur ist also noch möglich,
aber nur solange nicht versandt wird. Zeitkritisch.** Der Bot ändert keine
Bestellungen; das muss im Admin geschehen.**

> Dear Mr Calleros,
>
> Thank you for catching this quickly — and I'm glad you did, because the
> timing still works in your favour.
>
> **Your order has not shipped yet.** That means the address can still be
> corrected, which would not be true in a day or two.
>
> **What I cannot do is change it myself.** I do not have the ability to edit
> orders, and I am not going to tell you it is done when it is not. What I have
> done instead is put it in front of the shop owner **today, marked urgent and
> marked as "must be corrected before dispatch"**, with the address exactly as
> you gave it:
>
> > 2202 River Rd, River Grove, Illinois 60171
>
> **Please check that line and tell me immediately if I have any of it wrong** —
> it is the version that will be used.
>
> I am not going to promise you that it will be changed in time, because that
> is not mine to promise. What I will do is chase it if you have not heard back
> by tomorrow — just reply to this message.
>
> Kind regards,
> Lisa
> Paw-Friends Customer Support

⚠️ **Zusage darin:** die Weitergabe an den Owner **als dringend und als „vor
Versand zu korrigieren"**, und eine Nachfass-Zusage. **Nicht zugesagt, dass die
Adresse tatsächlich geändert wird** — das kann von hier niemand versprechen.
**Keine Bestellung bearbeitet** — der Bot ändert keine Bestellungen, und das
steht offen im Text. **Die alte Adresse wird ihm nicht zurückzitiert**, nur die
neue, die er selbst genannt hat, zur Kontrolle. **Keine Erstattung, kein
Betrag, keine Stornierung angesprochen** — danach hat er nicht gefragt. Kein
Eskalationsmarker im Text.

---

## #7160 — Kimberly „Kim" Maguire (kmags43@gmail.com)

**Betreff:** Re: Order #7160 confirmed

**Neu am 16.09. 17:06 UTC. Erstkontakt. Sie beruft sich ausdrücklich auf die
30-Tage-Garantie und fragt nach dem Verfahren — die vierzehnte Rückgabefrage.**

> Dear Kim,
>
> Thank you for writing, and for setting out the dates so clearly.
>
> **You asked what the process is from here, so here is the honest answer
> rather than a comfortable one: at the moment there is no return process I can
> give you.** We do not have a returns address published. **Please don't post
> the toy anywhere yet** — you would pay the postage and the parcel would have
> nowhere to arrive. The moment there is a route, you will get it from us
> without having to ask again.
>
> **On the guarantee you invoked.** I am not going to quote a condition back at
> you that I cannot show you. I have looked, and the "unused and in original
> condition" wording our replies keep citing **is not published on the product
> page you bought from**. I am telling you that because it is true, not because
> it settles anything.
>
> **On the refund itself:** I cannot authorise one, so you will get no promise
> from me and no refusal either. Your request went to the shop owner this
> evening with your dates — delivered on the 13th, first given to your dog on
> the 14th, torn within fifteen minutes — because those dates matter and I did
> not want them summarised away.
>
> I have not opened the photographs beyond seeing that they are there.
>
> If you have heard nothing in a few days, reply here and I will chase it.
...
⚠️ **Zusage darin:** die Weitergabe an den Owner **mit ihren Daten**, eine
Nachfass-Zusage, und die Zusage, dass sie die Rücksendeadresse
**unaufgefordert** bekommt, sobald es eine gibt. **Keine Erstattung zugesagt,
kein Betrag, keine Absage, keine Frist.** **Keine Rücksendeadresse — es gibt
keine**, samt Warnung. Die Feststellung zur Bedingung ist **belegt** (aus
`descriptionHtml` und `shopPolicies`) und **es wird ausdrücklich gesagt, dass
sie nichts entscheidet.** **Keine Aussage darüber, ob die Garantie Zerstörung
abdeckt.** **Dollar gegen Pfund nicht überbrückt und nicht erwähnt.**
**Das Trinkgeld auf ihrer Bestellung wird nicht angesprochen** — sie hat es
nicht erwähnt, und es gehört dem Owner zur Entscheidung. Fotos nicht geöffnet.
Kein Eskalationsmarker im Text.
...
kündigt Bewertungen an. Und das, was er als falsche Behauptung bezeichnet, ist
**der Produktname selbst**.**

> Dear Steve,
>
> Thank you for writing, and for being straightforward about what you intend to
> do.
>
> **You have not asked me for anything, and I am not going to talk you into or
> out of anything.** What you write publicly is entirely your own business.
> Nothing here is asked of you in return, and nothing about your order depends
> on it.
>
> **On the claim you are disputing:** you are quoting the product's own name
> back at us — it is sold as *"Designed for Furry Friends Who Destroy
> Everything"*. I am not going to pretend you have misread anything. Whether
> the product lives up to that name is the shop owner's to answer and not
> mine, and your message went to him this evening in your own words.
>
> **One thing I would rather you knew**, since you mentioned not wanting to
> waste more money returning it: **we do not have a returns address published
> at the moment anyway.** So please don't post it — you would be out the
> postage for nothing. If that changes, and if you want it, you will hear from
> us.
>
> **And if you would like a refund considered after all**, say so in one line
> and it goes to the owner as a refund request rather than as feedback. I
> cannot authorise one myself, so you would get neither a promise nor a refusal
> from me — but it would at least be in front of the person who decides.
>
> Kind regards,
> Lisa
> Paw-Friends Customer Support

⚠️ **Zusage darin:** nur die Weitergabe an den Owner und das Angebot, auf ein
Wort hin eine Erstattungsanfrage daraus zu machen. **Keine Erstattung zugesagt,
kein Betrag, keine Absage** — er hat nichts gefordert. **Er wird nicht gebeten,
die angekündigten Bewertungen zu unterlassen, zu ändern oder zu löschen**, und
**nichts wird davon abhängig gemacht.** **Keine Aussage darüber, ob das Produkt
dem Namen gerecht wird** — nur die belegte Feststellung, dass er den
**Produktnamen** korrekt zitiert. **Nicht behauptet, Kauschaden sei nicht
gedeckt.** Keine Rücksendeadresse, samt Warnung. Kein Eskalationsmarker im
Text.
...
**Neu am 17.09. 12:58 UTC**, nach dem 60-%-Angebot von 09:50.
...
**Sie hat recht mit dem, was sie beschreibt.** Die Angebote gingen
**30 → 35 → 40 → 50 → 60 %**, jeweils nach einer weiteren Ablehnung.

> Dear Rena,
>
> You have asked whether you need to send four more emails for the figure to
> reach 100%. I am not going to pretend I don't understand why you asked that.
>
> **You were offered 30%, then 35%, then 40%, then 50%, and this morning 60% —
> each one after you said no.** That is what the record shows, and I am not going
> to defend it as a coincidence. **I am also not going to make you a sixth offer
> today**, because another number from me would be exactly the thing you are
> objecting to.
>
> **The 60% you were sent this morning still stands** — that is the shop's offer,
> not mine to withdraw. But you asked for the full amount, and **that decision is
> the shop owner's, not mine.** So there is no promise from me here.
>
> **What has gone to him today, in your own words:** that you asked for the full
> amount on the grounds that the goods were not as advertised, that you have
> screen prints of the advertising you bought from, that you have spoken to
> Trading Standards, and that you waited over a month for delivery. I have not
> summarised your position or softened it.
>
> **On the advertising itself I am not going to give you a view**, for or against
> — you have the screen prints, and what they say is a matter for the person who
> placed the advertising, not for me.
>
...
⚠️ **Zusage darin:** die Weitergabe **mit wörtlicher Wiedergabe ihrer Position**
und der Nennung der Angebotsleiter, dazu eine Nachfass-Zusage. **Keine
Erstattung zugesagt, kein neuer Prozentsatz, kein Betrag, kein Termin.** **Das
bestehende 60-%-Angebot wird weder zurückgenommen noch erhöht noch wiederholt
angeboten.** **Keine rechtliche Einordnung** zur Werbung und **keine Aussage
dazu, ob die Werbung zutrifft.** Keine Bitte, Trading Standards nicht
einzuschalten, und keine Bedingung daran geknüpft. Keine Rücksendeadresse, samt
Warnung. Kein Eskalationsmarker im Text.

---

## #7163 — Chris McClelland (riomcclelland@gmail.com) — höfliche Erstanfrage, keine Beschwerde

**Betreff:** Re: Indestructible toys

**Neu am 17.09. 12:58 UTC. Erstkontakt.** Er beschwert sich nicht, er **fragt**:

> *„I was wondering if this would be returnable as it was stated that this would
> not happen if you had a dog who loved to chew."*
...
> Dear Chris,
>
> Thank you for writing, and for asking plainly rather than assuming the worst.
>
> **I am going to give you a straight answer rather than a policy paragraph.**
> The published thirty-day guarantee is written for items returned unused and in
> their original condition, so on its face it does not cover a toy a dog has
> already had. **That is the text; it is not a decision about your case, and I am
> not treating your question as closed.**
>
> **The reason I am not simply closing it:** you bought on the strength of what
> the product was described as withstanding, and that is a question about the
> description, not about the returns policy. I cannot rule on that, and I am not
> going to rule against you either. **It has gone to the shop owner today with
> your question as you put it.**
>
> So: **no refund promised from me, and no refusal from me either.** I would
> rather tell you a decision is pending than give you a firm no I am not entitled
> to give.
>
> Your photographs have arrived and are noted with the case. **Please don't post
> anything back yet** — we do not publish a returns address at present, so a
...
⚠️ **Zusage darin:** eine Weiterleitung an den Owner **mit seiner Frage im
Original**, die Bestätigung, dass Bildmaterial eingegangen ist, und eine
Nachfass-Zusage. **Keine Erstattung zugesagt, kein Betrag, keine Absage.** Der
Garantietext wird **zitiert, aber ausdrücklich nicht als Entscheidung über
seinen Fall ausgegeben.** Frist nur mit **30 Tagen** benannt. **Keine Aussage
dazu, ob die Werbeaussage zutrifft**, keine Aussage zur Haltbarkeit, **keine
...
**Neu am 17.09. 12:58 UTC. Erstkontakt.**
...
**Zwei Dinge, die im Entwurf Folgen haben:**

1. **Die Bestellung trägt überhaupt keine E-Mail-Adresse.** `#7275`, 22.08.,
   **44,26 £**, Reedy Creek (AU), 1 × Zahnbuddy + 2 × Plushies, `FULFILLED`,
   `totalRefundedSet` **0.00 £** — Feld `email` ist **`null`**. Der Name in der
   Lieferanschrift stimmt exakt (*Nathan Corcoran*), aber **ein Namensgleichklang
   ist keine Zuordnung.** Deshalb stehen **im Entwurf keine Bestellnummer, kein
   Betrag und keine Anschrift.** Der Owner muss das im Admin prüfen.
2. **Lieferung nach Queensland, Australien.** Damit wäre er der **vierte**
   australische Kunde, dem die Kauschaden-Vorlage die Bedingung „unbenutzt und in
   Originalverpackung" entgegenhält, der die einzige veröffentlichte AU-Passage
   ausdrücklich widerspricht — nach #7663, #7989 und #7885. **Hier wird die
   Vorlage gar nicht erst geschickt.**

Fotos beigefügt — **nicht geöffnet, nicht ausgewertet.**

> Dear Nathan,
>
> Thank you for writing, and for setting out exactly what happened and when.
>
> **I cannot authorise a refund**, so I am not going to promise you one — but you
> are also not getting a standard refusal from me, and I want to explain why
> rather than leave you guessing.
>
> **If your delivery address is in Australia**, then the returns section we
> publish for Australian customers says in as many words that Australian consumer
> rights **are not limited by the requirement that an item be unused or in its
> original packaging.** That is our own published text. It would not be honest of
> me to answer you with a policy line that our own published policy contradicts,
> so I have not.
>
> **One administrative point, and I would rather say it than quietly work around
> it.** The email address you are writing from is not recorded against any order
> in our system, so I cannot confirm from here which order is yours. That is why
> this reply contains no order number and no amount — not to stall you, but
> because matching you to an order on the strength of a name alone is not
> something I should do. **The shop owner can check this properly.**
>
> Your request and your photographs have gone to him today as: **a full refund
> requested, item received yesterday, damaged within about twenty minutes,
> purchased on the strength of the durability described.**
>
...
keine Absage.** **Keine Bestelldaten**, weil die Zuordnung nicht gesichert ist —
und das wird ihm offen gesagt statt verschwiegen; **kein Name, keine Anschrift,
keine Bestellnummer geraten.** Die AU-Passage wird **zitiert, nicht ausgelegt**;
**keine rechtliche Bewertung.** **Keine Auswertung der Fotos.** Keine Aussage
...
> Dear Lynette,
>
> **You have written on 15 September, on 17 September and again today, and you
> have had nothing back from us. That is our failure and I am starting there.**
>
> **What you were promised, and what happened to it.** On 10 September this
> address told you your case had been passed to a team who would check the
> delivery with the courier. **Twelve days later there is nothing on your case
> to show for it, and nobody came back to you.** I am not going to dress that
> up.
>
> **What our records show.** Order #5036 was placed on **8 August** and not
> handed over for despatch until **22 August — fourteen days later.** **£27.95
> is recorded on the order and nothing has been refunded.** The tracking
> reference on the order is the same one you were sent.
>
> **You asked for a refund on 9 September, and again today. That request stands
> and it has not been withdrawn by anything that happened since.** I cannot
> approve it myself — **so I am not going to promise you one and I am not going
> to refuse you one.** It is in front of the shop owner now, stated plainly:
> **paid 8 August, never received, refund requested 9 September, three
> follow-ups unanswered, nothing refunded.**
>
> **What I am not going to do is send you back to the courier.** You have
> already checked your property and asked your neighbours because we asked you
> to. **Chasing a parcel we despatched is not your job.**
>
> **On the Ombudsman and on feedback.** **That is entirely your decision and I
...
⚠️ **Zusage darin:** die **offene Feststellung, dass drei Nachfragen
unbeantwortet blieben**, die **Benennung der nicht eingelösten Zusage vom
10.09.**, die überprüfbare Wiedergabe der Daten (vierzehn Tage bis zum Versand),
die Feststellung, dass **ihre Erstattungsbitte vom 09.09. weiterhin gilt**, und
eine Nachfass-Zusage. **Keine Erstattung zugesagt, kein Betrag zugesagt, kein
Termin, keine Absage.** **Kein Verweis an den Versanddienstleister** — im
Gegenteil. **Kein Versuch, sie von Ombudsman oder öffentlicher Bewertung
abzubringen.** **Keine rechtliche Bewertung.** **Keine Aussage darüber, ob die
Sendung zugestellt wurde** — es wird nur wiedergegeben, was auf der Bestellung
steht. Kein Eskalationsmarker im Text.
...
> Dear Keith,
>
> **Your acceptance is recorded, and so is the way you gave it.** You wrote
> that it looks like you do not have a choice. **I am not going to file that as
> a happy customer, and I am not going to tell you that you do have a choice
> when from where you sit it may not look like one.**
>
> **What happens now, honestly.** The 50% offer was made by this address on
> **17 September** with the words *"we will arrange it for you"*. **You have
> now accepted it. That makes it an agreement, not a request still waiting to
> be judged** — and it goes to the shop owner as exactly that.
>
...
> toys unopened** — that is on the record as you described it. And **you have
> mentioned a dispute with your payment company; that is your decision and
> nothing here is conditional on you dropping it.**
>
> **You do not need to return anything, and please do not post anything back**
> — we have no returns address I can give you.
>
> Kind regards,
> Lisa
...
⚠️ **Zusage darin:** die **Bestätigung, dass seine Annahme eingegangen ist**,
die **Einordnung als geschlossene Vereinbarung statt offener Bitte**, die
**ausdrückliche Weigerung, eine Auszahlung zu behaupten oder einen Termin zu
nennen**, die Feststellung, dass **zwei Artikel ungeöffnet sind**, und eine
Nachfass-Zusage. **Keine neue Erstattung zugesagt, kein Betrag genannt, kein
Termin, keine Absage.** **Die Formulierung „processed" kommt nicht vor.**
**Sein Unmut wird nicht in Zufriedenheit umgedeutet.** **Nichts wird davon
abhängig gemacht, dass er den Zahlungsstreit zurückzieht.** **Keine
Rücksendeadresse erfunden.** **Kein Betrag umgerechnet.** Kein
Eskalationsmarker im Text.
...
> Dear Susan,
>
> **You have made a factual claim about our own wording, and you are entitled
> to a factual answer rather than a second copy of this morning's.**
>
> **I have read our published product text. Here is what is actually there.**
> The description of the toys you bought **contains no guarantee wording at
> all.** Where a 30-day money-back guarantee does appear in our material, **it
> appears without any condition about the item being unused.** **So on the
> narrow point you raised — that the guarantee as published says nothing about
> the toys being unused — our own text does not contradict you.**
>
> **What I am not going to do is tell you what follows from that.** Whether the
> condition quoted to you this morning can be applied anyway is **not mine to
> rule on**, and I would be inventing an answer if I gave you one. **What I can
> do is make sure the shop owner sees your sentence and that finding
> together**, which he now does.
>
> **And the reply you got this morning began "Dear Customer" and was a standard
> text.** You wrote to us on 18 September and waited four days for it. **Both
> of those are on us, and I am not sending you a second one.**
>
> **Your order, so you are not relying on my word.** Order #8407, placed
> **8 September**, despatched **9 September**, two toys, **£27.95 recorded on
> the order, nothing refunded.**
>
> **I cannot approve a refund myself — so I am not going to promise you one and
> I am not going to refuse you one.** **Your photograph arrived and has not
...
⚠️ **Zusage darin:** die **überprüfbare Auskunft über den eigenen
veröffentlichten Text** (Produktbeschreibung ohne Garantietext; Garantie
anderswo **ohne** Bedingung), die **ausdrückliche Bestätigung ihres engen
Punktes** ohne daraus eine Folge abzuleiten, die offene Benennung der Vorlage
und der vier Tage Wartezeit, und die Weitergabe mit Datum und Betrag. **Keine
Erstattung zugesagt, kein Betrag zugesagt, kein Termin, keine Absage, keine
zweite Vorlage.** **Keine rechtliche Bewertung der Bedingung.** **Keine
Behauptung, die Bedingung sei unwirksam — und keine, sie sei wirksam.** **Foto
...
> Dear Joanne,
>
> **Your order arrived this afternoon and one of the toys did not survive the
> day. I am not going to ask you to prove that or to photograph anything.**
>
> **What our records show, including the part you did not ask about.** Order
> #8126 was placed on **29 August** and not handed over for despatch until
> **8 September — ten days later.** **A$53.85 is recorded on the order and
> nothing has been refunded.** **I would rather you heard those ten days from
> us than worked them out yourself.**
>
> **You have not asked me for anything yet, and I am not going to decide on
> your behalf that you want money.** **If you would like this passed on as a
> refund request, one line back here is enough and it goes as that.** If you
> wanted us to know what happened, it goes as that. **Either is a complete
> answer.**
>
> **Because your order is an Australian one, here is our own published wording,
...
>
> **I cannot approve a refund or a replacement myself, so I am not going to
> promise you either and I am not going to refuse you either.** Your message is
> in front of the shop owner as you wrote it.
>
> **Please do not post anything back** — we have no returns address I can give
> you.
>
...
weiterzugeben, das **wörtliche Zitat der eigenen AU-Passage ohne Auslegung**,
und die Weitergabe mit Datum und Betrag. **Keine Erstattung zugesagt, kein
Ersatz zugesagt, kein Betrag zugesagt, kein Termin, keine Absage, keine
Vorlagen-Antwort.** **Keine Deutung ihrer Nachricht als Forderung.** **Kein Foto
verlangt, kein Anhang geöffnet.** **Keine rechtliche Bewertung.** **Keine
Umrechnung** — 53,85 A$ ist der presentment-Betrag. **Keine Rücksendeadresse
erfunden.** Kein Eskalationsmarker im Text.

## #8605 — Gurvinder Ghattaura (g_ghattora@yahoo.com) — GB, fragt nach dem Versandtermin, **Bestellung noch nicht übergeben**

**Betreff:** Re: Order #8605

> Dear Gurvinder,
>
> **A straight answer first: your order has not been handed over for despatch
> yet.** It was placed on **17 September**, and as of today **no despatch is
> recorded against it** and **both items are still showing as not yet sent.**
> **£27.95 is recorded on the order.**
>
> **I am not going to give you a date, because I would be making it up.** What
> I can tell you honestly is that **recent orders have taken anywhere from a
> few days to around two weeks to be handed over**, and **yours is five days
> in.** **That is the truthful answer, not a reassuring one.**
>
> **What I can do is make sure this is in front of the shop owner as a chase
> rather than a query**, which it now is.
>
> **And one thing you did not ask, which I would rather offer than leave you to
> discover.** **Nothing has shipped yet, so if you would prefer to cancel
> rather than keep waiting, that option is still open to you** — say the word
> here and it goes to him as a cancellation request. **I cannot cancel or
> refund from this desk myself, so I am not going to promise you either
...
⚠️ **Zusage darin:** die **direkte, überprüfbare Auskunft** (kein Versand
verzeichnet, beide Positionen offen, fünf Tage), die **ehrliche Weigerung,
einen Termin zu nennen**, die **wahrheitsgemäße Angabe der beobachteten
Spanne** statt einer Beschwichtigung, und der **ungefragte Hinweis auf die noch
offene Stornomöglichkeit**. **Keine Erstattung zugesagt, keine Stornierung
zugesagt oder ausgeführt, kein Termin, keine Absage.** **Keine Aussage zur
Herkunft der Sendung** — danach wurde nicht gefragt. **Keine
Sendungsverfolgungsnummer genannt** — es gibt keine. Kein Eskalationsmarker im
Text.
...
> Dear Tim,
>
> **You asked on 16 September for a refund to your original payment method.
> What you got back on 21 September was a standard text explaining why chewed
> toys are not covered. That is not an answer to what you asked, and I am not
> going to send you a second copy of it.**
>
> **Where your request actually stands.** It has not been decided. **I cannot
> approve a refund from this desk and I am not going to refuse you one either**
> — that decision belongs to the shop owner. **Your request is in front of him
> as you made it: a refund to the original payment method**, with your order:
> **#7041, £29.95 recorded on the order, nothing refunded.**
>
> **One thing worth saying plainly**, because it went unremarked when you first
> wrote: **you ordered on 21 August and the toys reached you on 15 September.**
> That is a long wait before any of this started, and **you should not have had
> to point it out.**
>
> **You have written from two different addresses about the same order.** That
> is not a problem at either end — **I mention it only so you know both are
> attached to the same case here and nothing of yours has been split off or
> lost.**
>
...
nicht beantwortet hat**, die Klarstellung, dass **seine Erstattungsbitte
weiterhin offen ist und nicht entschieden wurde**, die **ungefragte Nennung der
Wartezeit**, die Zusammenführung seiner beiden Adressen **ohne Vorwurf**, und
die Weitergabe mit Betrag. **Keine Erstattung zugesagt, kein Betrag zugesagt,
kein Termin, keine Absage, keine zweite Vorlage.** **Keine Behauptung, ihm sei
nie geantwortet worden** — es wird genau gesagt, was er wann bekommen hat.
...
> Dear Jill,
>
> **You have now asked three times to return the toy your dog never touched,
> and three times you have been sent the same text explaining why chewed toys
> are not covered. Your toy is not chewed. I am not sending you a fourth
> copy.**
>
> **Here is the answer you have actually been asking for, and it is not a good
> one: there is no returns address I can give you.** We do not have one to hand
> out. **So please do not post anything back** — not because your request is
> refused, but because there is nowhere for it to go. **I would rather tell you
> that plainly than have you pay postage to nowhere.**
>
> **What our own published text says, since it is the basis of your request.**
> The page for the Fluffys you bought carries a **30-day money-back guarantee**,
> and **it is stated there without any condition attached.** The condition
> quoted to you — unused and in original condition — **is one your item
> actually meets.** **So nothing in what you have been sent explains why an
> untouched toy in its packaging cannot come back.**
>
> **What I am not going to do is tell you that settles it.** I cannot approve a
> refund from this desk, and I am not going to promise you one or refuse you
> one. **What I have done is put it in front of the shop owner stated plainly:
> order #7347, placed 23 August, despatched 2 September, two Fluffys, £29.95
> recorded on the order, one toy unopened and untouched, return and refund
...
⚠️ **Zusage darin:** die **offene Feststellung, dass dreimal dieselbe Absage auf
eine Frage kam, die sie nicht gestellt hat**, die **endliche Antwort auf ihre
tatsächliche Bitte** (keine Rücksendeadresse — mit ausdrücklicher Warnung, nichts
zu verschicken), die **überprüfbare Auskunft über den eigenen Garantietext auf
der Fluffys-Seite** (ohne Bedingung), die Feststellung, dass **ihr Artikel die
zitierte Bedingung erfüllt**, und die Weitergabe mit allen Daten. **Keine
Erstattung zugesagt, kein Betrag zugesagt, kein Termin, keine Absage, keine
vierte Vorlage.** **Keine rechtliche Bewertung.** **Keine Behauptung, damit sei
...
> Dear Paul,
>
> **You have taken this morning's reply at its word, and that was the right
> thing to do. It said the guarantee applies to items returned unused and in
> their original condition, and you have one exactly like that.**
>
> **So here is the honest answer, and I am sorry it is this one: there is no
> returns address I can give you.** We do not have one. **The text you were
> sent describes a process we cannot actually carry out. Please do not post
> anything back** — I would rather say that now than have you pay postage to
> nowhere.
>
> **That is not a refusal of your request.** I cannot approve a refund from
> this desk and **I am not going to promise you one or refuse you one.** Your
> request is in front of the shop owner as you made it: **order #8312, placed
> 31 August, despatched 8 September, two toys, £27.95 recorded on the order,
> one item unused in its original packaging, return and refund requested,
> nothing refunded.**
>
...
⚠️ **Zusage darin:** die **Bestätigung, dass er die Vorlage richtig verstanden
hat**, die **offene Feststellung, dass der zugesagte Ablauf nicht durchführbar
ist**, die ausdrückliche Warnung, nichts zu verschicken, und die Weitergabe mit
allen Daten. **Keine Erstattung zugesagt, kein Betrag zugesagt, kein Termin,
keine Absage, keine zweite Vorlage.** **Keine Rücksendeadresse erfunden.**
...
> Dear Heather,
>
> **You wrote asking when your refund would be processed. What came back this
> morning was a standard text explaining why you were not getting one, addressed
> to "Dear Customer". That is not an answer, and it is not how this should have
> reached you.**
>
> **Let me clear up the thing underneath it, because I think it matters more
> than the tone.** **No refund is in progress on your order.** There is none
> recorded and none pending. **I do not know what gave you the impression that
> one was running, and I am not going to guess** — but you were entitled to a
> straight answer about it rather than a policy paragraph, and **you should not
> have had to ask twice to find out.**
>
> **Your order, so you are not relying on my word.** Order #5310 was placed on
> **9 August** and despatched on **13 August**. **$38.47 is recorded on the
> order and nothing has been refunded.**
>
> **On the advertising.** You called the toys indestructible in your first
> message and you have called the advertising false in this one. **I have read
> all twelve of our current product descriptions and the word "indestructible"
> is not in any of them. That is not me telling you that you did not see it** —
> I cannot see the advertising that was put in front of you, and **I am not
> going to guess at it or explain it away.** **Your words go to the shop owner
> exactly as you wrote them**, because he is the only person who can look at
> the advertising itself.
>
> **On making it known: that is your decision and I am not going to try to talk
> you out of it.** It changes nothing about how this is handled here.
>
> **I cannot approve a refund myself, so I am not going to promise you one and
> I am not going to refuse you one.** Your request is in front of him.
> **Your photographs arrived and have not been opened; you do not need to send
> anything else**, and please do not post the toys back — we have no returns
> address I can give you.
>
...
⚠️ **Zusage darin:** die **offene Benennung der Vorlage und der „Dear
Customer"-Anrede**, die **klare Auskunft, dass keine Erstattung läuft**, die
ehrliche Feststellung, dass **nicht rekonstruierbar ist, woher ihr Eindruck
stammt**, die Auskunft zum geprüften Produkttext, und die Weitergabe mit Datum
und Betrag. **Keine Erstattung zugesagt, kein Betrag zugesagt, kein Termin,
keine Absage, keine zweite Vorlage.** **Keine Behauptung, das Wort
„indestructible" existiere nicht.** **Keine Rekonstruktion der Anzeige.** **Kein
Versuch, sie von einer öffentlichen Äußerung abzubringen.** **Fotos nicht
...
> Dear Karen,
>
> **You are right on every point, and you should not have had to make them
> twice.**
>
> **First, the reply you got on 21 September was wrong and should never have
> reached you.** It explained why chew damage is not covered. **Nothing of
> yours is chewed. You reported a missing item.** **I am not going to defend
> that message and I am not sending you another one like it.**
>
> **Second, what our records actually show — including something that has not
> been put in front of you.**
>
> - **On 28 August you asked us to confirm your order as 1 × Hippo and
>   1 × Frog.** **On 30 August this address confirmed it in writing**, saying
>   your requested selection would be noted.
> - **That change was never made on the order.** **Order #7989 records one
>   line: two Plushies, both the hippo variant.** **There is no frog on it and
>   there never was.**
> - **The despatch records both of those items going out together, and you
>   received one.**
>
> **So there are two separate failures here, not one, and I am not going to
> fold them into each other:** **a variant you were promised in writing and
> never got onto your order**, and **an item that is recorded as despatched and
> did not arrive.** **Both go to the shop owner exactly as they stand.**
>
> **You asked for the cost of the Frog to be refunded. I cannot approve that
> from this desk, so I am not going to promise it and I am not going to refuse
> it.**
>
> **And I am not going to put a figure on it myself.** Your order was bought on
> a two-for-one, so **the A$53.87 recorded on it is the price of the pair, not
> of one toy.** **Working out what one item comes to has to be done from the
> shop's own records, not by me halving a bundle price.** **Nothing has been
> refunded so far.**
>
> **You do not need to send anything else. Your photograph arrived and has not
...
⚠️ **Zusage darin:** die **ausdrückliche Feststellung, dass die Kauschaden-Absage
vom 21.09. falsch war und nicht aufrechterhalten wird**, der **Nachweis der
schriftlichen Variantenzusage vom 30.08. und dass sie nie auf die Bestellung
kam**, die **getrennte Behandlung beider Fehler**, und die Weitergabe mit dem
Datenstand. **Keine Erstattung zugesagt, kein Betrag genannt, kein Termin, keine
Absage, keine zweite Vorlage.** **Kein Anteil aus dem Bundle-Preis geschätzt** —
und ausdrücklich gesagt, warum nicht. **Ihr wird nicht gesagt, sie habe sich
verzählt** — im Gegenteil, der Datenstand stützt sie. **Keine Rücksendung
verlangt.** **Foto nicht geöffnet.** **Keine Umrechnung** — 53,87 A$ ist der
presentment-Betrag. Kein Eskalationsmarker im Text.
...
> Dear Aaron,
>
> **You wrote on 20 September that the product is advertised as one no dog has
> ever destroyed. What came back two days later was a standard text explaining
> why chewed toys are not covered, addressed to "Dear Customer". That did not
> engage with what you said, and I am not going to send you another copy of
> it.**
>
> **On the sentence you put at the centre of it — that you should not be
> penalised because the advertising is misleading — I am not going to argue
> with you.** **What I can honestly do is tell you what is and is not
> checkable from here.**
>
> - **I have read all twelve of our current product descriptions.
>   "Indestructible" is not in any of them**, and **the description of the toys
>   you bought carries no guarantee wording at all.**
> - Where a **30-day money-back guarantee** does appear in our own marketing
>   material, **it appears without any condition attached** — **which is not
>   the version that was quoted to you.**
> - **I cannot see the advertising that was put in front of you.** **So I am
>   not going to tell you what it said, and I am certainly not going to suggest
>   you misread it.** **Your words go to the shop owner as you wrote them**,
>   because he is the only person who can look at it.
>
> **What I cannot do.** I cannot approve a refund or a replacement from this
> desk. **So I am not going to promise you either and I am not going to refuse
> you either** — **and the message of 22 September should not be read as a
> decision.** Your case is in front of him with the order: **#7440, placed
> 23 August, not handed over for despatch until 3 September — eleven days —
> two toys, $38.90 recorded on the order, nothing refunded.**
>
> **Please do not post anything back** — we have no returns address I can give
> you.
>
...
⚠️ **Zusage darin:** die **offene Benennung der Vorlage und der „Dear
Customer"-Anrede**, die **überprüfbare Auskunft über den eigenen Text**
(Produktseite ohne Garantie; Garantie im Marketing **ohne** Bedingung — anders
als zitiert), die ehrliche Eingrenzung, und die **ausdrückliche Feststellung,
dass die Absage keine Entscheidung war.** **Keine Erstattung zugesagt, kein
Ersatz zugesagt, kein Betrag zugesagt, kein Termin, keine Absage, keine zweite
Vorlage.** **Keine Behauptung, das Wort „indestructible" existiere nicht.**
**Keine Rekonstruktion der Anzeige.** **Keine rechtliche Bewertung.** **Keine
Rücksendeadresse erfunden.** **Keine Umrechnung.** Kein Eskalationsmarker im
Text.
...
> Dear Colin,
>
> **A straight answer rather than a reassurance.** Order #8432 was placed on
> **9 September** and handed over for despatch on **14 September**, with the
> reference **UL510080231YP** (Yanwen). **Our record shows no update against
> that despatch since the day it was created — nine days ago.**
>
> **So if the tracking has not moved for you, it has not moved for us either.
> I am not going to tell you it is on its way when all I can see is the same
> thing you can.**
>
> **I am not going to give you a delivery date, because I would be making it
> up.**
>
> **And I am not going to send you to the carrier.** **Chasing a parcel we
> despatched is not your job.**
>
> **You have not asked me for anything beyond the whereabouts, and I am not
> going to decide on your behalf.** **But if you would rather have this passed
> on as a refund request than as a tracing request, one line back here is
...
⚠️ **Zusage darin:** die **überprüfbare Auskunft mit Datum und Referenz**, die
**offene Feststellung, dass seit neun Tagen keine Aktualisierung vorliegt**,
der ausdrückliche Verzicht auf eine Beschwichtigung, **kein Verweis an den
Versanddienstleister**, und das neutrale Angebot. **Keine Erstattung zugesagt,
kein Liefertermin genannt, keine Absage.** **Keine Aussage darüber, wo das
Paket ist.** **Keine Aussage zur Herkunft der Sendung** — danach wurde nicht
...
> Dear Nikki,
>
> **You wrote to us twice within a couple of minutes, in two separate email
> threads. I am answering both here once, so this does not end up being
> handled twice or half-handled.**
>
> **You asked a procedural question — how you claim the 30-day money-back
> guarantee — and it deserves a straight answer rather than a policy
> paragraph.**
>
> **The honest answer is that I cannot process that claim from this desk.**
> **I am not refusing it.** **The decision on your order is the shop owner's,
> and your message goes to him today, in your words.**
>
> **What I can tell you is what is checkable from here**, because you are
> entitled to know what our own material actually says:
>
> - I have read all twelve of our current product descriptions. **The word
>   "indestructible" is not in any of them.**
...
>
> **I am not going to tell you that the guarantee covers what happened, and I
> am not going to tell you it does not.** **Neither of those is mine to say,
> and a confident answer from me in either direction would be worth nothing to
> you.** **What I can do is make sure the question reaches the person who can
> answer it, with our own wording in front of him.**
>
> **I also cannot see the advertisement you actually read**, so I am not going
> to tell you what it said or suggest you misremember it.
>
> **One thing you should know before you do anything with the toys: there is no
> returns address to send them to.** **We do not have one to give you.** **So
> please do not post anything back** — **that is not a refusal, it is simply
> where things stand, and it would cost you postage for nothing.**
>
> **You do not need to send photographs, and nothing here depends on you
> producing evidence.**
>
> **What is on the order:** #7208, placed **22 August**, not handed over for
...
Antwort auf ihre Verfahrensfrage** (von hier aus nicht bearbeitbar, Entscheidung
beim Owner), die **überprüfbare Auskunft über den eigenen Text** — kein
„indestructible" in den zwölf Beschreibungen, **kein Garantietext auf der
gekauften Seite**, Garantie im Marketing **ohne Bedingung** —, die **klare
Auskunft, dass es keine Rücksendeadresse gibt**, mit der ausdrücklichen Bitte,
nichts zu verschicken. **Keine Erstattung zugesagt, kein Betrag zugesagt, kein
Termin, keine Absage, keine Vorlage.** **Nicht behauptet, die Garantie decke
Kauschäden — und nicht behauptet, sie decke sie nicht.** **Keine erfundene
Fundstelle für eine Bedingung.** **Keine Rekonstruktion der Anzeige.** **Keine
Aussage zur Produktqualität, in keine Richtung.** **Kein Foto verlangt.** **Der
Name „Winston" wird nicht gedeutet und nicht einer Variante zugeordnet**, und
die unterschiedliche Stückzahl in ihren beiden Nachrichten wird **nicht gegen
den Bestellsatz aufgerechnet.** **Sie wird mit dem Namen angesprochen, mit dem
sie unterschreibt** (die Bestellung lautet auf „Nicola"). Kein Eskalationsmarker
im Text.

## #8270 — Paul Thomas (paulthomas2407@gmail.com) — GB, **Erstkontakt, Lieferzeit und Qualität, keine Forderung gestellt**

**Betreff:** Re: Poor product

> Dear Paul,
>
> **You raised two separate things, and I want to keep them apart rather than
> answer one and quietly skip the other.**
>
> **1. The wait.** **You are right, and I am not going to soften it.** Order
> #8270 was placed on **30 August**. **It was not handed over for despatch
> until 8 September — nine days before it even started moving**, and the
> delivery time you experienced came on top of that. **That is our delay, not
> the carrier's**, and nobody told you about it at the time.
>
> **2. The toy itself.** **You have told me what happened and I am recording it
> exactly as you wrote it.** **I am not going to make a claim about the quality
> of the toy in either direction** — not to defend it and not to agree with
> you — **because that is not mine to decide and you would rightly not believe
> either version from me.** **Your message goes to the shop owner today in your
> own words.**
>
> **What I am deliberately not doing: you have not asked me for anything.** You
> told us you are dissatisfied, and you did not ask for a refund, a replacement
> or a return. **I am not going to decide on your behalf what you wanted.**
> **If you would like this passed on as a refund request, one line back here is
> enough and it goes forward that way.** **If you would rather it simply be
> recorded as a complaint, that is what it stays.**
>
> **One thing you should know either way: there is no returns address to send
> the toy to.** **We do not have one to give you.** **So please do not post
> anything back** — it would cost you postage for nothing.
>
> **You do not need to send photographs.**
>
...
⚠️ **Zusage darin:** die **getrennte Behandlung seiner beiden Punkte**, die
**offene Bestätigung der Verzögerung mit Datum** (neun Tage bis zur Übergabe,
als eigener Fehler benannt, **kein Verweis an den Versanddienstleister**), das
**neutrale Angebot statt einer Deutung** — er hat nichts gefordert —, und die
**klare Auskunft, dass es keine Rücksendeadresse gibt.** **Keine Erstattung
zugesagt, kein Betrag zugesagt, kein Termin, keine Absage, keine
Kauschaden-Vorlage.** **Keine Aussage über die Qualität des Artikels, in keine
Richtung.** **Nichts über die Garantie behauptet** — er hat sie nicht
angerufen. **Nichts über Rasse, Alter oder Umgang des Hundes gefolgert.**
**Keine Deutung seiner Schilderung als Erstattungsforderung.** **Kein Foto
...
> Dear Ivan,
>
> **You have had a reply from us today that did not answer what you actually
> said, and I am not going to pretend otherwise.**
>
> **What you told us was that the toy lasted eight minutes and that you believe
> the advertising is a scam.** **What came back was a paragraph about chew
> damage.** **That was not a decision on your order, and it should not have
> read like one.**
>
...
> descriptions. **The word "indestructible" is not in any of them.** **The
> description of the toys you bought carries no guarantee wording at all.** And
> where a **30-day money-back guarantee** does appear in our own marketing
> material, **it appears without any condition attached to it.**
>
...
> refuse it either.** **That is the shop owner's decision, and your message
> goes to him today in your own words.** **I am aware you set us a deadline
> before, and that it passed without anything happening. That is on us, not on
> you.**
>
...
> down, and nothing here is conditional on what you do or do not post.**
>
> **What is on the order:** #8295, placed **31 August**, not handed over for
...
⚠️ **Zusage darin:** die **offene Feststellung, dass die heutige Antwort seine
Aussage nicht beantwortet hat und keine Entscheidung war**, die überprüfbare
Auskunft über den eigenen Text, die **Anerkennung der abgelaufenen Frist als
eigenes Versäumnis**, und die **Weitergabe an den Owner**. **Keine Erstattung
zugesagt, kein Betrag, kein Termin, keine Absage.** **Kein Versuch, ihn von
einem öffentlichen Beitrag abzubringen**, nichts davon abhängig gemacht, und
**nicht um Entfernung gebeten.** **Keine Behauptung, „indestructible" existiere
...
> Dear Wendy,
>
> **You are right, and I am not going to argue with you about it.**
>
> **You wrote on 19 September, again on 21 September, and again on
> 23 September.** **Nothing came back.** **The first thing you received from us
> was today's reply, and it was a standard paragraph that did not address what
> you asked.** **After five days of silence that is not an answer, and I
> understand exactly why you called it what you called it.**
>
> **The question you put — whether you are supposed to look at the toy and not
> let the dog play with it — is a fair one and I am not going to talk around
> it.** **I am not going to tell you the guarantee covers what happened, and I
> am not going to tell you it does not.** **Neither is mine to decide.** **What
> I can tell you is what our own material says**, because you should not have
> to take my word for anything: **the description of the toys you bought
> carries no guarantee wording at all**, and where a **30-day money-back
> guarantee** appears in our marketing, **it appears without any condition
> attached to it.**
>
> **Your original question was how to return the items.** **The honest answer
> is that there is no returns address.** **We do not have one to give you.**
> **So please do not post anything back** — it would cost you postage for
> nothing. **You should have been told that five days ago.**
>
> **On going to your bank and on leaving a review: both are entirely your
> decision.** **I am not going to ask you to hold off on either, and nothing
> here depends on you doing so.**
>
> **Your refund is not mine to approve or refuse.** **It goes to the shop owner
> today, in your words, along with the fact that you had to write four times.**
>
> **What is on the order:** #8142, placed **29 August**, not handed over for
> despatch until **8 September — ten days** — two toys, **£27.95 recorded on
> the order, nothing refunded to date.**
>
> Kind regards,
> Lisa
...
⚠️ **Zusage darin:** die **ausdrückliche Bestätigung, dass sie recht hat**, die
**offene Benennung der fünf Tage Schweigen und der Vorlage als unzureichende
erste Antwort**, die Beantwortung ihrer **eigentlichen Frage nach der
Rücksendung** (es gibt keine Adresse), und die überprüfbare Auskunft über den
eigenen Text. **Keine Erstattung zugesagt, kein Betrag, kein Termin, keine
Absage.** **Nicht behauptet, die Garantie decke Kauschäden — und nicht
behauptet, sie decke sie nicht.** **Kein Versuch, sie von Bank oder Bewertung
...
> Dear Jill,
>
> **You have now asked three times for the same thing — to return the toy you
> never used — and three times you have been offered a percentage instead.**
> **Today you were offered 30 % again, after you had already declined it. That
> should not have happened.**
>
> **So let me answer the thing you actually asked, plainly.**
>
> **There is no returns address.** **We do not have one to give you, and I am
> not going to invent one to make this email easier to write.** **That is why
> the return you keep asking for has not been arranged — not because your
> request was unreasonable.** **Please do not post the toy anywhere; it would
> cost you postage and you would very likely lose the item as well.**
>
> **I am also not going to offer you a percentage a third time.** **You have
> said no twice and I have no business asking again.**
>
> **What I can do is put it in front of the person who can actually decide.**
> **Your request — a return and a full refund for the unused toy, not a partial
> one — goes to the shop owner today, in your own words.** **I am not going to
> promise you the answer, because I do not control it.**
>
> **One point I want on the record for him, in your favour: the item you are
> asking about is unused and in its original packaging.** **That is your
> statement and I am passing it on as your statement, not as something you have
> to prove.** **You do not need to send photographs.**
>
> **What is on the order:** #7347, placed **23 August**, despatched
> **2 September**, two toys, **£29.95 recorded on the order, nothing refunded
> to date.** **I am deliberately not quoting a figure for the single unused
> toy** — the £29.95 is a two-for-one price and splitting it in half would be a
> guess, not a fact.
>
> Kind regards,
> Lisa
...
⚠️ **Zusage darin:** die **offene Feststellung, dass ihr dreimal an ihrer Frage
vorbei geantwortet wurde**, die **klare Auskunft, dass es keine
Rücksendeadresse gibt**, die ausdrückliche Bitte, nichts zu verschicken, **kein
drittes Prozentangebot**, und die Weitergabe **ihrer Forderung in ihrer eigenen
Formulierung**. **Keine Erstattung zugesagt, kein Betrag, kein Termin, keine
Absage.** **Kein Anteil aus dem Bündelpreis geschätzt** — und gesagt, warum
...
> Dear Kerri,
>
> **You have now told us three times that you did not use the product, and
> three times you have been sent a paragraph about damage caused by a dog.**
> **The third one went out today. That is our failure, not a misunderstanding
> on your part, and I am sorry.**
>
> **I am reading what you wrote as you wrote it: the items are unused, in their
> original packaging, undamaged, and you want to return them for a refund.**
> **Nothing in this reply treats them as chewed.**
>
> **You asked for details on how to return them, so here is the honest
> answer: there is no returns address.** **We do not have one to give you, and
> I am not going to make one up.** **Please do not post the parcel** — it would
> cost you international postage and you would very likely lose the items on
> top of it. **That is not a refusal of your refund. It is the state of things,
> and you were entitled to hear it the first time you asked.**
>
> **Your refund is not mine to approve or refuse — that decision is the shop
> owner's.** **What goes to him today is your request as you wrote it,
> together with the fact that you received the wrong reply three times.**
>
> **You do not need to send photographs or prove anything.**
>
> **What is on the order:** #8372, placed **7 September**, **$96.89 recorded on
> the order, nothing refunded to date.** **There is also a further item on the
> order — the e-book — still recorded as not sent.** That is separate, and it
> goes to him too.
>
> Kind regards,
> Lisa
...
⚠️ **Zusage darin:** die **ausdrückliche Anerkennung der dreifachen falschen
Antwort als eigener Fehler**, die **Behandlung ihrer Ware als ungenutzt** — wie
sie es geschrieben hat —, die **klare Auskunft, dass es keine Rücksendeadresse
gibt**, mit Warnung vor Porto- und Warenverlust, und der **ungefragte Hinweis
auf die unausgelieferte E-Book-Position.** **Keine Erstattung zugesagt, kein
Betrag, kein Termin, keine Absage.** **Kein Kauschadenfall daraus gemacht.**
**Kein Nachweis, kein Foto verlangt.** **Keine Aussage zur Qualität.** Kein
Eskalationsmarker im Text.
...
> Dear John,
>
> **You wrote to us because of an advertisement you saw about a guarantee, and
> what came back today was a paragraph about chew damage.** **That was not a
> decision on your order, and I am not going to leave you thinking it was.**
>
> **What you said is that the toys did not last as described.** **I am not
> going to tell you that they did.** **I am also not going to tell you what the
> advertisement you saw said, because I cannot see it and I am not going to
> reconstruct it for you.**
>
> **What I can tell you is what our own material says**, which you can hold me
> to: I have read all twelve of our current product descriptions, and **the
> word "indestructible" is not in any of them.** **The descriptions of the toys
> on your order carry no guarantee wording at all.** And where a **30-day
> money-back guarantee** does appear in our own marketing, **it appears without
> any condition attached to it.**
>
> **Your refund question is not mine to approve or refuse.** **It goes to the
> shop owner today, in your own words.**
>
> **What is on the order:** #2852, placed **9 July**, despatched **17 July**,
> **$47.76 recorded on the order, nothing refunded to date.** **There is also a
> further item on the order — the e-book — still recorded as not sent.** Nobody
> has mentioned that to you; it goes to him as well.
>
> **You do not need to send photographs.**
>
> Kind regards,
...
⚠️ **Zusage darin:** die **Feststellung, dass die heutige Vorlage keine
Entscheidung war**, die überprüfbare Auskunft über den eigenen Text, und der
**ungefragte Hinweis auf die unausgelieferte E-Book-Position.** **Keine
Erstattung zugesagt, kein Betrag, kein Termin, keine Absage.** **Keine
Behauptung, „indestructible" existiere nicht.** **Keine Rekonstruktion der
Facebook-Anzeige, auf die er sich beruft.** **Keine Aussage zur Qualität oder
...
> Dear Josephine,
>
> **You wrote on 23 September and again today, and nothing came back to you in
> between. That is on us.**
>
> **You have asked when you will be refunded. The honest answer is that I
> cannot tell you, because I cannot approve the refund from this desk and I
> have no date to give you.** **I am not going to invent one to end this email
> politely.** **What I can tell you is that your request is with the shop owner
> and that it is the fifth time you have asked.**
>
> **The thing I most want to reach you before anything else:** on 23 September
> you said you would send the items back to our "UK department". **There is no
> UK department and there is no returns address.** **We do not have one to give
> you, and I am not going to make one up.** **If you have not posted anything
> yet, please do not** — you would lose the postage and most likely the items
> as well. **If you have already sent something, tell me and I will make sure
> that goes to him with the rest, today.**
>
> **You have now said clearly that you do not wish to keep the products.** That
> is recorded exactly as you put it, and it is the fourth time you have made
> your position plain. **I am not going to offer you another percentage.** You
> have declined 30 % and 40 %, and asking a third time would be pressure, not
> service.
>
> **I am not going to make a claim about the products in either direction.**
> You have described them in your own words and those words go forward
> unchanged.
>
> **On Klarna and on Trading Standards: both are entirely your decision.** **I
> am not going to ask you to hold off, and nothing here depends on you doing
> so.**
>
> **What is on the order:** #7048, placed **21 August**, not handed over for
> despatch until **2 September — twelve days** — two toys, **£27.95 recorded on
> the order, and the refund record is empty.**
>
> Kind regards,
> Lisa
> Paw-Friends Customer Support

⚠️ **Zusage darin:** die **Anerkennung der zwei Tage Schweigen als eigenes
Versäumnis**, die **ehrliche Auskunft, dass kein Termin genannt werden kann**,
die **erneute, an erster Stelle stehende Warnung vor der Rücksendung an eine
nicht existierende „UK department"**, **kein drittes Prozentangebot**, und die
Weitergabe ihrer Formulierung unverändert. **Keine Erstattung zugesagt, kein
Betrag, kein Termin, keine Absage.** **Nicht angenommen, sie habe das Paket
bereits abgeschickt — und nicht angenommen, sie habe es nicht**; beides wird
offen gefragt. **Keine Aussage über die Qualität der Artikel, in keine
Richtung.** **Kein Versuch, sie von Klarna oder Trading Standards abzubringen.**
...
> **Thank you for writing, and for setting out the dates so clearly.**
>
> **You have told us what happened and you have not asked us for anything
> specific, so I am not going to decide on your behalf what you wanted.** **If
> you would like this passed on as a refund request, one line back here is
> enough. If you would rather it simply be recorded, that is what it stays.**
> **Either way it is with the shop owner today, in your own words.**
>
> **You did say one thing I can check, and you can hold me to it:** you paid
> more than usual for toys you understood to be indestructible. **I have read
> all twelve of our current product descriptions. The word "indestructible" is
> not in any of them**, and **the descriptions of the two toys on your order
> carry no guarantee wording at all.** Where a **30-day money-back guarantee**
> does appear in our own marketing material, **it appears without any condition
> attached to it.**
>
> **I cannot see the advertisement you actually read, so I am not going to tell
> you what it said, and I am not going to suggest you misread it.**
>
> **I am not going to make a claim about the toys themselves in either
> direction**, and **I am not drawing any conclusion from the fact that two
> dogs had them.**
>
> **Your photographs are on the file and you do not need to send anything
> further.**
...
> cost you postage for nothing. **That is not a refusal of anything.**
>
> **What is on the order:** #8552, placed **15 September**, despatched
...
⚠️ **Zusage darin:** das **neutrale Angebot statt einer Deutung** — er fordert
nichts Bestimmtes —, die überprüfbare Auskunft über den eigenen Text, und die
...
Absage, keine Kauschaden-Vorlage.** **Keine Behauptung, „indestructible"
existiere nicht.** **Keine Rekonstruktion der Anzeige.** **Keine Aussage zur
Qualität oder Haltbarkeit, in keine Richtung.** **Keine Folgerung daraus, dass
zwei Hunde die Artikel hatten.** **Keine Aussage zum Preis oder dazu, ob er
angemessen war.** **Kein Foto verlangt**, ausdrücklich abbestellt. **Er wird
...
- **Tamara (usclawyertamara@gmail.com, Sammelklage angedroht)** — nach
  `support-policy.md` gehört dieser Fall ungekürzt an den Owner, zusätzlich mit
  einer eigenen Mail an `nevio.marasa@icloud.com`. Ein Support-Text von „Lisa"
  ist hier nicht das richtige Instrument.
- **Carol Shoesmith** — sie verlangt die Firmenanschrift für ein Verfahren. Es
  gibt keine hinterlegte Korrespondenzadresse; der Bot erfindet keine. Owner-Entscheidung.
- **Jason Branch (Trading Standards)** — dasselbe.
- **Alle Rückgabefälle** — es gibt keine Rücksendeadresse. Solange das so ist,
  ist kein „unbenutzt zurück"-Fall abschließbar.
...
4. Die Vorlagen-Absage bei bestrittenen Werbeaussagen abschalten — am 29.08.
   ...
   angekündigten öffentlichen Bewertungen.
5. Die Rückfrage-Vorlage bei Stornierungen abschalten — sie widerspricht Regel 3.
